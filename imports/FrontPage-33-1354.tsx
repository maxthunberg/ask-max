import svgPaths from "./svg-5n3gvfczfs";
...
function InputField() {
  return (
    <div className="absolute bg-[rgba(255,255,255,0.1)] box-border content-stretch flex gap-[12px] items-center left-[156px] px-[12px] py-[16px] rounded-[12px] top-[518px] w-[640px]" data-name="Input field">
...
function HeroSection() {
  return (
    <div className="absolute contents left-0 top-0" data-name="Hero Section">
      ...
      <TextContainer />
      <Group2 />
      <p className="absolute font-['Figtree:Regular',sans-serif] font-normal leading-[18px] left-[156px] opacity-70 text-[#c7c1cc] text-[12px] text-nowrap top-[582px] whitespace-pre">Just like the real Max, my digital twin can also make mistakes.</p>
      <Image />
      <Details />
    </div>
  );
